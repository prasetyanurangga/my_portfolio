...
export default function AboutMe() {
  ...
  const profile = {
    ...
    url_cv : '../static/Resume - Angga Nur Prasetya.pdf'
  }
  ...
  return (
    <MainLayout currentMenu="About Me">
      <div class={tw`flex flex-col py-8  xs:px-8 lg:px-16`}>
        ...
        <span class={tw`text-xl font-normal text-black mb-5`}>Hey, I'm {profile.nama}</span>
        ...
        <div class={tw`flex lg:flex-row xs:flex-col justify-around lg:space-x-16`}>
          ...
          <div class={tw`lg:w-1/2 flex flex-col items-center`}>
            ...
            <span class={tw`text-lg font-normal text-black w-full`}>Skills</span>
              ...
              skills.map((itemLanguages) => 
                <div class={tw`flex flex-col my-3 w-full`}>
                  <div class={tw`flex flex-row justify-between items-center`}>
                    <span class={tw`text-lg font-bold text-black`}>{itemLanguages.name}</span>
                    <span class={tw`text-md font-normal text-black`}>{itemLanguages.value}%</span>
                  </div>
