	...
	return (
		<>
			<div class={tw`text-center flex justify-center items-center min-h-screen flex-col bg-white relative`}>
				<svg onClick={executeScroll} class={tw`cursor-pointer absolute top-10 left-10 animate-bounce w-8 h-8`} xmlns="http://www.w3.org/2000/svg"  fill="currentColor"  viewBox="0 0 16 16">
